<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Movies.aspx.cs" Inherits="F2.Movies" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<ef:EntityDataSource ID="edsChat" runat="server" 
			...
			EntitySetName="SitePageContents" Where="it.PageUrl='Movies.aspx'" >
	</ef:EntityDataSource>
</asp:Content>
