<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="FunChat.aspx.cs" Inherits="F2.FunChat" %>
								...
								<div style="margin:1em 0 0 -3em">
									...
									<span class="myContents">
										<div >
											...
											<div>Funchat Service Description</div>
										</div>
										<%#Eval("DisplayContent") %>
									</span>
